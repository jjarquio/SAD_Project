...
?>
          ...
          <a onclick = "return confirm('Are you sure?')" href="show_pending.php?idd=<?php echo $row['Job_order_no']; ?>" ><button class = "btn btn-danger">Delete </button></a>
		    </tr>
					...
					<?php
							if(isset($_GET['idd'])){
								...
								if($result){
									...
									<script>
										alert("Data deleted");
										window.location.href='show_pending.php';
										</script>
									<?php
								}else{
									?>
